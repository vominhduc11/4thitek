...
export const translations = {
    en: {
        ...
        reseller: {
            ...
            fallbackMessage: 'Unable to load live data.',
            hours: 'Hours',
            phone: 'Phone',
            email: 'Email',
        ...
        warrantyCheck: {
            ...
            demo: {
                title: 'Check your serial number',
                description: 'Enter the serial number printed on your product or warranty card to verify coverage.',
                active: 'Enter the serial number from your product.',
                expired: 'Contact support if the serial number cannot be verified.',
        ...
        becomeReseller: {
            ...
            form: {
                ...
                subtitle: 'This is the official dealer registration portal. Submit your business details here before using the Dealer app.',
                portalBadge: 'Official Registration Portal',
                portalTitle: 'Register here before signing in on the Dealer app',
                portalDescription: 'Use this form to create your dealer application and account details. Our team will review the information and contact you if additional verification is needed.',
                portalFootnote: 'The Dealer app is reserved for accounts that have already been created or approved through this website.',
                ...
                successMessage: 'We\'ll review your application and get back to you within 24 hours. Once approved, you can sign in on the Dealer app with this account.',
        ...
        errors: {
            ...
            products: {
                ...
                maxRetries: 'Max retry attempts reached. Please reload the page.',
                notFound: 'Product not found'
            },
            blogs: {
            ...
            warranty: {
                loadFailed: 'Failed to check warranty',
                invalidSerial: 'Invalid product serial number',
                notFound: 'Warranty information not found',
                purchaseDateMissing: 'Purchase date is missing',
                serialMissing: 'Product serial is missing',
                customerMissing: 'Customer information is missing'
            },
            reseller: {
                loadFailed: 'Failed to load reseller information',
                errorTitle: 'Error Loading Resellers',
                fallbackMessage: 'Unable to load live data.',
                connectionError: 'Connection error. Please try again.',
                notFound: 'No resellers found'
            },
            general: {
...
export const extraTranslations = {
    en: {
        ...
        about: {
            breadcrumb: 'About',
            errorTitle: 'Unable to load about page',
            errorMessage: 'Please try again later.',
            loadingTitle: 'Loading about page',
            loadingMessage: 'Preparing our story...',
            mission: {
        ...
        blog: {
            ...
            grid: {
                ...
                emptyBodyLine1: 'We could not find any articles that match your filters.',
                emptyBodyLine2: 'Try adjusting your filters or check back later.',
                readArticle: 'Read article'
            },
            list: {
                cachedNotice: 'Showing cached articles while we reconnect.',
                categoryFallback: 'General',
                checkingConnection: 'Checking connection...'
            },
            detail: {
                loadingTitle: 'Loading article',
                loadingMessage: 'Fetching article details...',
                loadFailedMessage: 'Unable to load this article. Please try again.',
                mediaImageAlt: 'Blog image',
                mediaImageAltIndexed: 'Blog image {index}',
        ...
        certification: {
            ...
            errorTitle: 'Unable to load certification page',
            errorMessage: 'Please try again later.',
            loadingTitle: 'Loading certifications',
            loadingMessage: 'Fetching certification details...'
        },
        contact: {
            errorTitle: 'Unable to load contact page',
            errorMessage: 'Please try again later.',
            loadingTitle: 'Loading contact page',
            loadingMessage: 'Preparing contact details...',
            social: {
        ...
        becomeReseller: {
            form: {
                ...
                citySelectFirst: 'Select city first',
                errors: {
                    ...
                    addressMax: 'Address must be 255 characters or less.',
                    districtMax: 'District must be 100 characters or less.',
        ...
        errors: {
            blogs: {
                loadFailedMessage: 'Unable to load blog posts. Please try again later.'
            },
            general: {
                maxRetries: 'Maximum retry attempts exceeded. Please reload the page.',
                unexpectedError: 'An unexpected error occurred.'
            },
            products: {
                loadFailedMessage: 'Unable to load product. Please try again later.'
            },
            reseller: {
                responseFormatError: 'Server response format changed. Please update the application.'
            },
            pages: {
                becomeReseller: {
                    title: 'Reseller program error',
                    message: 'Failed to load reseller program information. Please try again.'
                },
                policy: {
                    title: 'Policy page error',
                    message: 'Failed to load policy information. Please try again.'
                },
                search: {
                    title: 'Search error',
                ...
                resellerInfo: {
                    title: 'Reseller information error',
                    message: 'Failed to load reseller information. Please try again.'
                }
            },
            global: {
        ...
        hero: {
            ariaLabel: 'Featured product {product}',
            discoverAria: 'Discover {product}',
            errors: {
                fallbackNotice: 'Please retry to load content.'
            }
        },
        home: {
            loadingTitle: 'Loading homepage',
            loadingMessage: 'Preparing the latest highlights...'
        },
        newsroom: {
            exploreMoreAria: 'Explore more articles',
        ...
        pagination: {
            ...
            summary: 'Showing {start}-{end} of {total} {label}'
        },
        policy: {
            tableOfContents: 'Table of Contents',
            errors: {
                title: 'Policy unavailable',
                message: 'Unable to load the {policy} policy. Please try again later.',
                hint: 'If the issue persists, contact support.'
            }
        },
        products: {
            loadingTitle: 'Loading products',
            loadingMessage: 'Fetching product catalog...',
            filters: {
                ...
                emptyBody: 'No products match your current filters. Try adjusting your search criteria.',
                title: 'Filters',
                count: '{filtered} of {total} products',
                breadcrumbAll: 'All',
                breadcrumbProducts: 'Products',
                breadcrumbFilter: 'Filter'
            },
            list: {
                titleAll: 'All Products',
                titlePosition: '{position} Products',
                showingAll: 'Showing all {count} products',
                showingFiltered: 'Showing {count} products in {category}',
            ...
            positions: {
                all: {
                    label: 'All',
                    description: 'Explore the full lineup across every tier.'
                },
                entry: {
                    label: 'Entry Level',
                    shortDescription: 'Reliable essentials for daily riders.',
                    description: 'Affordable communication gear with solid performance for everyday use.'
                },
                midRange: {
                    label: 'Mid-range',
                    shortDescription: 'Balanced performance and features.',
                    description: 'Best balance of quality, features, and value for most riders.'
                },
                premium: {
                    label: 'Premium',
                    shortDescription: 'Advanced features and clarity.',
                    description: 'High-end audio, extended range, and premium comfort.'
                },
                ultimate: {
                    label: 'Ultimate',
                    shortDescription: 'Top-tier performance.',
                    description: 'Flagship communication systems with maximum range and features.'
                },
                items: [
                    {
                        id: '1',
                        label: 'Entry Level',
                        description: 'Reliable essentials for daily riders.',
                        img: '',
                        positionKey: 'Entry'
                    },
                    {
                    ...
                    },
                    {
                        id: '3',
                        label: 'Premium',
                        description: 'Advanced features and clarity.',
                        img: '',
                        positionKey: 'Premium'
                    },
                    {
            ...
            featured: {
                discoverAria: 'Discover {name}',
                empty: 'No featured products available.',
                goTo: 'Go to {target}',
                loading: 'Loading featured products...',
                navigationAria: 'Featured products navigation',
                next: 'Next product',
            ...
            additionalContent: {
                ...
                distributor: {
                    ...
                    description: 'Certified partners nationwide with genuine products and dedicated support.'
                }
            },
            detail: {
                ...
                media: {
                    detailImageAlt: 'Product detail image',
                    detailImageAltIndexed: 'Product detail image {index}',
                    imageAlt: 'Product image',
                    imageAltIndexed: 'Product image {index}',
                    videoTitle: 'Product video',
                    videoUnavailable: 'Video unavailable'
                },
                noContent: 'No product details available.',
                noRelatedProducts: 'No related products found.',
                productLabel: 'Product',
                retailerShort: 'Retailers',
                selectSection: 'Select section',
                shuffle: 'Shuffle products',
                shuffleLoading: 'Shuffling...',
                videoUnsupported: 'Your browser does not support video playback.'
            },
            specifications: {
                title: 'Specifications',
                updating: 'Updating specifications...',
                labels: {
                    cable: 'Cable',
                    connector: 'Connector',
            ...
            videos: {
                ...
                emptyHint: 'Check back soon for updates.',
                emptyWithName: 'No videos available for {name}.',
                featuredDescription: 'Watch product highlights and setup tips.',
                featuredTitle: 'Featured video for {name}',
                noVideo: 'Video is not available.',
                title: 'Product Videos',
                unavailable: 'Video unavailable.',
                videoAbout: 'About {title}'
            },
            warranty: {
                ...
                covered: {
                    ...
                    items: [
                        ...
                        'Battery performance issues within warranty period'
                    ]
                },
                notCovered: {
                    ...
                    steps: [
                        {
                            ...
                            description: 'Provide your serial number and purchase date.'
                        },
                        {
                            title: 'Contact Support',
                            description: 'Reach out with details about the issue.'
                        },
                        {
                            title: 'Diagnosis',
                            description: 'We verify coverage and troubleshoot the issue.'
                        },
                        {
                            title: 'Repair or Replace',
                            description: 'We repair or replace eligible parts.'
                        }
                    ]
                },
                contact: {
        ...
        reseller: {
            clickMarkerForDetails: 'Click a marker for details.',
            mapIframeTitle: 'Reseller Location Map',
            mapAttribution: 'Powered by Google Maps',
            status: {
                unavailable: 'API temporarily unavailable. Please try again later.',
                checking: 'Checking connection...'
            },
            dealerFallback: 'Dealer {index}'
        },
        search: {
            ...
            modal: {
                ...
                noResultsBody: 'No results for \"{query}\". Try a different search.',
                noResultsTitle: 'No results found',
                recentTitle: 'Recent searches',
                searchingBody: 'Searching for \"{query}\"...',
            ...
            page: {
                ...
                breadcrumb: 'Search',
                emptyBody: 'Enter a keyword to find products and articles.',
                emptyTitle: 'Start your search',
                filterLabel: 'Filter',
                loading: 'Searching...',
                noResultsBody: 'No results for \"{query}\". Try another search.',
                noResultsTitle: 'No results found',
                queryLabel: 'Results for',
                resultsCount: '{count} results',
                resultsTitle: 'Search Results',
                suggestions: {
                    default: ['Bluetooth', 'Intercom', 'Helmet', 'Accessories'],
                    noResults: ['Bluetooth 5.0', 'Noise canceling', 'Group intercom', 'Waterproof']
                }
            }
        },
        social: {
        ...
        warrantyCheck: {
            errorTitle: 'Unable to check warranty',
            errorMessage: 'Please try again later.',
            loadingTitle: 'Checking warranty',
            loadingMessage: 'Searching warranty information...',
            errors: {
                networkTitle: 'Network error',
                networkMessage: 'Please check your connection and try again.',
                notFoundTitle: 'Product not found',
                notFoundMessage: 'We could not find warranty information for this serial number.',
                serverTitle: 'Server error',
                serverMessage: 'The server is unavailable. Please try again later.',
                unknownTitle: 'Unexpected error',
                unknownMessage: 'An unexpected error occurred. Please try again.',
                tips: {
                    title: 'Tips',
                    items: [
            ...
            export: {
                ...
                productSkuLabel: 'Product SKU',
                warrantyInfoTitle: 'Warranty Information',
                purchaseDateLabel: 'Purchase Date',
                warrantyEndDateLabel: 'Warranty End Date',
                warrantyCodeLabel: 'Warranty Code',
                statusLabel: 'Status',
            ...
            result: {
                ...
                active: {
                    ...
                    message: '{days} days remaining on your warranty.',
