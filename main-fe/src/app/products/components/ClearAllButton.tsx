...
export default function ClearAllButton({ isVisible, onClearAll }: ClearAllButtonProps) {
    ...
    return (
        <motion.button
            onClick={onClearAll}
            className="w-full bg-gradient-to-r from-red-600/20 to-red-500/10 hover:from-red-600/30 hover:to-red-500/20 border border-red-500/30 text-red-400 font-semibold py-3 px-4 2xl:py-4 2xl:px-6 3xl:py-5 3xl:px-8 rounded-xl 2xl:rounded-2xl 3xl:rounded-3xl text-base 2xl:text-lg 3xl:text-xl transition-all duration-300 flex items-center justify-center gap-2 2xl:gap-3 3xl:gap-4"
