...
export default function ProductHero({
        ...
        const initStickyBreadcrumb = () => {
            ...
            const createStickyElement = () => {
                ...
                itemsToUse.forEach((item, index) => {
                    ...
                    const isActive = (activeBreadcrumb || t('products.detail.breadcrumbs.productDetails')) === item.label;
    ...
    }, [breadcrumbItems, activeBreadcrumb, onBreadcrumbClick, t]);
        ...
        >
            ...
            <div className="absolute inset-0 z-0">
                ...
                >
                    ...
                    {t('products.detail.videoUnsupported')}
                </video>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 items-center w-full max-w-3xl xl:max-w-5xl lg:gap-1 xl:gap-8">
                        ...
                        <div className="hidden lg:flex items-center justify-center">
                            ...
                            >
                                ...
                                {isShuffling ? t('products.detail.shuffleLoading') : t('products.detail.shuffle')}
                            </motion.button>
                        </div>
                            ...
                            <div className="text-center mb-4 sm:mb-6 md:mb-8 lg:mb-16">
                                <AnimatePresence mode="wait">
                                    <motion.h1
                                        ...
                                        title={product.name}
                                        className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold text-white leading-tight xs:leading-tight sm:leading-tight md:leading-tight lg:leading-tight xl:leading-tight max-w-[320px] xs:max-w-[380px] sm:max-w-[480px] md:max-w-[600px] lg:max-w-[720px] desktop:max-w-[860px] xl:max-w-[860px] 2xl:max-w-[980px] 3xl:max-w-[1100px] 4xl:max-w-[1200px] px-2 xs:px-3 sm:px-4 text-center"
                                    >
                                        {product.name}
                                    </motion.h1>
                                </AnimatePresence>
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                            >
                                {t('products.detail.retailerShort')}
                                <svg
