        ...
        return (
            <section className="py-16 bg-[#0a0f1a]">
                <div className="container mx-auto max-w-[1800px] px-4 relative py-4 pb-2 pt-8 sm:-mt-8 md:-mt-8">
                    <h2 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl 3xl:text-6xl 4xl:text-7xl 5xl:text-8xl font-bold text-white mb-12 2xl:mb-16 3xl:mb-20 4xl:mb-24 5xl:mb-28 text-center">
                        {t('products.detail.relatedProducts')}
                    </h2>
                    <div className="bg-gray-900/50 rounded-2xl border border-gray-700/50 p-6 text-center">
                        <p className="text-gray-400 text-sm sm:text-base">{t('products.detail.noRelatedProducts')}</p>
                    </div>
                </div>
            </section>
        );
                            ...
                            >
                                ...
                                >
                                    {product.images?.[0]?.url ? (
                                        ...
                                        <div className="flex h-[140px] w-[140px] items-center justify-center text-4xl opacity-70 sm:h-[160px] sm:w-[160px] md:h-[180px] md:w-[180px] lg:h-[200px] lg:w-[200px] xl:h-[220px] xl:w-[220px] 2xl:h-[280px] 2xl:w-[280px] 3xl:h-[320px] 3xl:w-[320px] 4xl:h-[360px] 4xl:w-[360px] 5xl:h-[400px] 5xl:w-[400px]">
                                            {'\u{1F3A7}'}
                                        </div>
                                    )}
                                </motion.div>
