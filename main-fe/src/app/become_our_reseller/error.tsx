...
export default function BecomeOurResellerError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Become Our Reseller page error:', error);
  }, [error]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="text-lg font-semibold text-red-400 mb-2">{t('errors.pages.becomeReseller.title')}</h3>
        <p className="text-gray-300 mb-6">
          {error.message || t('errors.pages.becomeReseller.message')}
        </p>
