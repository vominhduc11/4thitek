...
const operationalPageTranslations: TranslationMap = {
  // ── Common nav/action labels ──────────────────────────────────────────────
  "Tiếp": "Next",
  "Trước": "Previous",
  "Xem chi tiết": "View details",
  "Chưa có": "Not provided",
  "Loại": "Type",
  "Đang cập nhật...": "Updating...",
  "Tạo bởi": "Created by",
  "Xử lý lúc": "Resolved at",
  "Mã giao dịch": "Transaction code",
  "Thanh toán lúc": "Paid at",
  "Nhận lúc": "Received at",
  "Trạng thái hiện tại": "Current status",
  "Trạng thái mới": "New status",
  "Ghi chú xử lý": "Resolution note",
  "Ghi chú bắt buộc": "Required note",
  "Thử thay đổi bộ lọc hoặc tải lại dữ liệu.": "Try a different filter or reload the data.",
  ...
  // ── Orders page ───────────────────────────────────────────────────────────
  "Đơn hàng": "Orders",
  "Theo dõi xử lý đơn, xác nhận trạng thái và ưu tiên giao hàng.": "Track order processing, confirm statuses, and keep shipping priorities clear.",
  ...
  "Thử điều chỉnh bộ lọc hoặc từ khóa tìm kiếm.": "Try another filter or search keyword.",
  "Không thể tải đơn hàng": "Unable to load orders",
  "Không tải được danh sách đơn hàng": "Could not load the order list",
  "Cần xem xét": "Needs review",
  "Chậm giao": "Overdue to ship",
  "Bạn có chắc muốn chuyển đơn này sang trạng thái \"{status}\" không?": "Do you want to move this order to \"{status}\"?",
  "Hành động này sẽ xóa đơn hàng khỏi danh sách quản trị.": "This will remove the order from the admin list.",
  "Không cập nhật được đơn hàng": "Could not update the order",
  "Không xóa được đơn hàng": "Could not delete the order",
  // ── Dealers page ──────────────────────────────────────────────────────────
  "Đại lý": "Dealers",
  "Quản lý hồ sơ đại lý, doanh thu và trạng thái kích hoạt tài khoản.": "Manage dealer profiles, revenue, and account activation state.",
  "Tìm đại lý": "Search dealers",
  "Tìm theo tên, mã hoặc email...": "Search by name, ID, or email...",
  ...
  "Bạn có chắc muốn chuyển trạng thái đại lý này sang \"{status}\" không?": "Do you want to change this dealer to \"{status}\"?",
  "Không cập nhật được trạng thái đại lý": "Could not update dealer status",
  "Lý do tạm khóa": "Suspension reason",
  "Nhập lý do tạm khóa đại lý...": "Enter the reason for suspending this dealer...",
  // ── Financial settlements page ────────────────────────────────────────────
  "Quyết toán tài chính": "Financial settlements",
  "Xử lý các mục hoàn tiền, ghi có hoặc xóa sổ từ một workspace rõ ràng thay vì chỉ xem danh sách.": "Handle refunds, credits, and write-offs from a focused workspace instead of a passive list.",
  "Đã hoàn tiền": "Refunded",
  "Đã xóa sổ": "Written off",
  "Đã ghi có": "Credited",
  "Danh sách quyết toán": "Settlement queue",
  "Chọn một mục để xem đầy đủ bối cảnh và ra quyết định.": "Select an item to review the full context and make a decision.",
  "Chi tiết xử lý": "Resolution details",
  "Xem loại quyết toán, lịch sử và chốt kết quả ngay tại panel này.": "Review the settlement type, audit trail, and finalize the outcome from this panel.",
  "Ghi chú xử lý là bắt buộc.": "A resolution note is required.",
  "Lưu quyết định": "Save decision",
  "Không có mục quyết toán phù hợp": "No settlement items found",
  "Không tải được danh sách quyết toán": "Unable to load settlements",
  "Danh sách quyết toán chưa thể tải.": "The settlement list could not be loaded.",
  "Đã cập nhật quyết toán.": "Settlement updated.",
  "Chưa chọn mục quyết toán": "No settlement selected",
  "Hãy chọn một mục ở danh sách để xem đầy đủ chi tiết và xử lý.": "Choose an item from the queue to inspect details and resolve it.",
  "Mục đang mở": "Open items",
  "Mục này vẫn đang chờ quyết định": "This item still needs a decision",
  "Luôn ghi rõ lý do để đội vận hành theo dõi lại sau này.": "Always record the reasoning so operations can review it later.",
  "Mục này đã được chốt kết quả": "This item has already been resolved",
  "Thông tin bên dưới chỉ còn để tra cứu. Muốn thay đổi kết quả cần backend hỗ trợ luồng riêng.": "The fields below are now read-only. Changing the outcome would require a separate backend flow.",
  "Hoàn hoặc điều chỉnh khi hủy đơn": "Cancellation refund or adjustment",
  "Rà soát đơn quá hạn": "Stale order review",
  "Mô tả cách bạn đã xử lý mục quyết toán này...": "Describe how this settlement item was handled...",
  // ── Recent payments page ──────────────────────────────────────────────────
  "Thanh toán chuyển khoản": "Recorded bank transfers",
  "Theo dõi các khoản chuyển khoản đã được ghi nhận, lọc theo đại lý và thời gian.": "Browse recorded bank-transfer payments, then filter by dealer and time window.",
  "Tất cả đại lý": "All dealers",
  "Từ thời điểm": "From",
  "Đến thời điểm": "To",
  "Số tiền từ": "Min amount",
  "Số tiền đến": "Max amount",
  "Không có giao dịch phù hợp": "No matching payments",
  "Không tải được dữ liệu": "Unable to load data",
  "Không tải được danh sách giao dịch chuyển khoản.": "Could not load recent transfer payments.",
  "Tổng giao dịch": "Total payments",
  "Danh sách giao dịch": "Payment queue",
  "Chọn một giao dịch để xem chi tiết thanh toán và thông tin liên quan.": "Select a payment to inspect the recorded transfer details.",
  "Chi tiết giao dịch": "Payment details",
  "Kiểm tra đơn hàng, mã giao dịch và thời điểm ghi nhận giao dịch.": "Review the order, transaction code, and recorded timestamps for this transfer.",
  "Chọn một giao dịch để xem chi tiết": "Select a payment to view details",
  // ── Unmatched payments page ───────────────────────────────────────────────
  "Thanh toán không khớp": "Unmatched payments",
  "Xem các giao dịch SePay chưa ghép được với đơn hàng, đọc nhanh nguyên nhân và xử lý từng case ngay trong một màn hình.": "Review SePay transfers that are not matched to an order, scan the root cause quickly, and resolve each case from one workspace.",
  "Đã khớp": "Matched",
  "Tất cả lý do": "All reasons",
  "Không tìm thấy đơn": "Order not found",
  "Sai số tiền": "Amount mismatch",
  "Đơn đã thanh toán": "Order already settled",
  "Đơn đã hủy": "Order cancelled",
  "Danh sách case": "Case queue",
  "Chọn một giao dịch để xem chi tiết và xử lý.": "Choose a payment to inspect details and resolve it.",
  "Kiểm tra nguyên nhân, đơn gợi ý và cập nhật kết quả xử lý.": "Review the cause, suggested order, and record the resolution outcome.",
  "Đơn gợi ý": "Suggested order",
  "Đơn đã khớp": "Matched order",
  "Mã đơn để ghép": "Match to order ID",
  "Số tiền ghép": "Allocation amount",
  "Để trống để ghép toàn bộ số tiền giao dịch.": "Leave empty to allocate the full unmatched amount.",
  "Đơn mục tiêu": "Target order",
  "Tổng đơn": "Order total",
  "Còn phải thu": "Outstanding",
  "Lưu xử lý": "Save resolution",
  "Không tải được danh sách giao dịch": "Unable to load payments",
  "Đã cập nhật trạng thái giao dịch.": "Payment status updated.",
  "Không tải được thông tin đơn hàng.": "Could not load target order details.",
  "Vui lòng nhập mã đơn cần ghép khi chọn trạng thái Đã khớp.": "Please provide a target order ID when status is Matched.",
  "Mã đơn không hợp lệ.": "Invalid order ID.",
  "Vui lòng nhập ghi chú xử lý trước khi lưu.": "Please provide a resolution note before saving.",
  "Số tiền ghép phải là một số lớn hơn 0.": "Allocation amount must be a number greater than 0.",
  "Số tiền ghép không được vượt quá số tiền của giao dịch này.": "Allocation amount cannot exceed this payment amount.",
  "Chưa chọn giao dịch nào": "No payment selected",
  "Hãy chọn một case ở danh sách bên trái để xem chi tiết và xử lý.": "Choose a case from the list to inspect details and resolve it.",
  "Tổng case": "Total cases",
  "Cần xử lý": "Pending",
  "Đã xử lý": "Resolved",
  "Case đang chờ xử lý": "This case still needs resolution",
  "Ưu tiên xác nhận lại đơn gợi ý trước khi chốt kết quả.": "Confirm the suggested order before finalizing the result.",
  "Mô tả cách bạn xử lý giao dịch này...": "Describe how this payment was handled...",
  // ── Order detail page ─────────────────────────────────────────────────────
  "In đơn hàng": "Print order",
  // ── Profile page ──────────────────────────────────────────────────────────
  "Hồ sơ tài khoản": "Account profile",
  "Thông tin tài khoản quản trị của bạn.": "Your admin account information.",
  "Tên đăng nhập": "Username",
  "Quyền hạn": "Permissions",
  "Đổi mật khẩu": "Change password",
  "Hãy đặt mật khẩu mạnh và không chia sẻ tài khoản với người khác.": "Use a strong password and do not share your account credentials.",
};
...
const translations: Record<Language, TranslationMap> = {
  ...
  en: {
    ...
    "Đã xóa": "Deleted",
    "Bản nháp": "Draft",
    "Hero trang chủ: Tất cả": "Homepage hero: All",
    "Hiển thị ở Hero trang chủ": "Show in homepage hero",
    "Không hiển thị ở Hero trang chủ": "Do not show in homepage hero",
    "Danh sách sản phẩm trang chủ: Tất cả": "Homepage product list: All",
    "Hiển thị trong danh sách sản phẩm trang chủ": "Show in homepage product list",
    "Không hiển thị trong danh sách sản phẩm trang chủ": "Do not show in homepage product list",
    "Hero trang chủ": "Homepage hero",
    "Danh sách sản phẩm trang chủ": "Homepage product list",
    "Danh sách trang chủ": "Homepage list",
    "Lọc theo sản phẩm cấp dữ liệu cho Hero đầu trang chủ.": "Filter products that feed the homepage hero.",
    "Lọc theo sản phẩm xuất hiện trong section danh sách sản phẩm ở homepage.": "Filter products that appear in the homepage product list section.",
    "Ẩn khỏi Hero trang chủ": "Hide from homepage hero",
    "Ẩn khỏi danh sách sản phẩm trang chủ": "Hide from homepage product list",
    "Thiết lập hiển thị này chỉ điều khiển dữ liệu cho Hero trang chủ và danh sách sản phẩm trang chủ, không tạo thêm section riêng.": "These visibility settings only control data for the homepage hero and homepage product list. They do not create separate sections.",
    "Chỉ dùng để chọn sản phẩm cho khu vực Hero đầu trang chủ. Main-fe hiện dùng featuredProducts[0] cho HeroSection.": "Use this only to choose the product for the homepage hero area. Main-fe currently uses featuredProducts[0] for HeroSection.",
    "Dùng để hiển thị sản phẩm trong section danh sách sản phẩm ở trang chủ. Main-fe hiện dùng homepageProducts cho ProductSeries.": "Use this to show the product in the homepage product list section. Main-fe currently uses homepageProducts for ProductSeries.",
    "Hero trang chủ: cấp dữ liệu cho khu vực hero đầu trang. Main-fe hiện lấy featuredProducts[0] cho HeroSection.": "Homepage hero: feeds the top hero area. Main-fe currently takes featuredProducts[0] for HeroSection.",
    "Danh sách trang chủ: cấp dữ liệu cho section danh sách sản phẩm. Main-fe hiện dùng homepageProducts cho ProductSeries.": "Homepage list: feeds the product list section. Main-fe currently uses homepageProducts for ProductSeries.",
    ...
    "+ Hình ảnh": "+ Images",
    "+ Mô tả": "+ Description",
    "+ Nhiều hình ảnh": "+ Many images",
    "+ Video": "+ Videos",
    "Anh toi da 10MB": "I have 10MB",
    "Bạn có thay đổi chưa lưu trong biểu mẫu tạo sản phẩm.": "You have unsaved changes in the product creation form.",
    "Bạn có thay đổi chưa lưu trong sản phẩm này.": "You have unsaved changes in this product.",
    "Bỏ khỏi mới ra mắt": "Quit just released",
    "Bỏ nổi bật": "Quit highlighting",
    "Bộ lọc nâng cao": "Advanced filters",
    "Chuyển khoản ngân hàng": "Bank transfer",
    "Chuyển đơn này sang \"{status}\"?": "Convert this order to \"{status}\"?",
    "Chuyển đại lý này sang trạng thái \"{status}\"?": "Move this agent to state \"{status}\"?",
    "Chú thích hình ảnh": "Image caption",
    "Chú thích video": "Video captions",
    "Chưa có khối nội dung nào.": "There are no content blocks yet.",
    "Chưa có lịch sử thanh toán.": "No payment history yet.",
    "Chưa có thông tin mặt hàng.": "No item information available.",
    "Chưa thanh toán": "Not yet paid",
    "Chưa xác định": "Not determined",
    "Chế độ sắp xếp hiện tại": "Current sort mode",
    "Chọn loại khối ở phía trên để thêm tiêu đề, đoạn mô tả, hình ảnh, bộ ảnh hoặc video vào trang chi tiết sản phẩm.": "Select the block type above to add a title, description, image, photo gallery, or video to the product detail page.",
    "Cài đặt tài khoản đại lý": "Set up an agent account",
    "Các khối trống sẽ bị bỏ qua khi lưu.": "Empty blocks will be ignored when saving.",
    "Các tab sản phẩm": "Product tabs",
    ...
    "Dùng khi cần xác nhận tiền đã nhận ngoài webhook tự động.": "Used when you need to confirm money received outside of an automatic webhook.",
    "Email hoặc tên...": "Email or name...",
    "Ghi chú nội bộ": "Internal notes",
    "Ghi có": "Credit",
    "Ghi nhận hoàn tiền": "Record refund",
    "Ghi nhận thanh toán": "Payment recording",
    "Ghi nhận thanh toán thủ công": "Record payments manually",
    "Ghi nhận điều chỉnh, bù trừ hoặc hoàn tiền cho đơn hàng. Số âm làm giảm đã thu, số dương bổ sung đã thu.": "Record adjustments, offsets or refunds for orders. The negative number that reduces is collected, the positive number that adds is collected.",
    "Ghi đè": "Overwrite",
    "Giá 0 VND vẫn được phép, nhưng hệ thống sẽ hỏi xác nhận khi tạo.": "Prices of 0 VND are still allowed, but the system will ask for confirmation when creating.",
    "Giá trị thông số": "Parameter value",
    "Giữ lại": "Keep it",
    "Gợi ý: dùng chữ in hoa, số và dấu gạch ngang để dễ tìm kiếm.": "Hint: use capital letters, numbers and hyphens for easy searching.",
    "Hotline": "Hotline",
    "Hoàn tác": "Undo",
    "Hành động": "Act",
    ...
    "Không có nhật ký phù hợp.": "There are no proper logs.",
    "Không cập nhật được đại lý": "Unable to update agent",
    "Không ghi nhận được thanh toán": "Payment not recorded",
    "Không thêm được điều chỉnh": "Cannot add adjustments",
    "Không thể cập nhật": "Unable to update",
    "Không thể cập nhật trạng thái xuất bản": "Unable to update publishing status",
    "Không thể khôi phục sản phẩm": "The product cannot be restored",
    "Không thể lưu sản phẩm": "The product cannot be saved",
    "Không thể tạo sản phẩm": "Unable to create product",
    "Không thể tải ảnh lên. Vui lòng thử lại.": "Unable to upload photo. Please try again.",
    "Không thể tải ảnh sản phẩm": "Unable to load product image",
    "Không thể xóa sản phẩm": "The product cannot be deleted",
    "Không thể xử lý tệp đã chọn": "The selected file cannot be processed",
    "Không thể ẩn sản phẩm": "Products cannot be hidden",
    "Không tìm thấy đơn hàng": "Order not found",
    "Không tìm thấy đại lý": "No agent found",
    "Không tải được chi tiết đơn hàng": "Unable to load order details",
    "Không tải được lịch sử thanh toán": "Unable to download payment history",
    "Không tải được lịch sử điều chỉnh": "Unable to download adjustment history",
    "Không tải được nhật ký": "Unable to download log",
    "Không tải được đại lý": "Unable to load agent",
    "Khối": "Block",
    "Kéo để sắp xếp": "Drag to sort",
    "Kênh": "Channel",
    "Liên hệ nhanh": "Contact quickly",
    "Loại thực thể": "Entity type",
    "Loại điều chỉnh": "Adjustment type",
    "Lên": "Go up",
    "Lý do (tối thiểu 10 ký tự)": "Reason (minimum 10 characters)",
    "Lý do phải có ít nhất 10 ký tự": "The reason must be at least 10 characters",
    "Lý do tạm khóa": "Reason for temporary lock",
    "Lịch sử thanh toán": "Payment history",
    "Lịch sử thao tác quản trị.": "History of administrative operations.",
    "Mã tham chiếu": "Reference code",
    "Mã tham chiếu (tuỳ chọn)": "Reference code (optional)",
    "Mô tả video": "Video description",
    "Mẫu sẽ ghi đè nội dung bạn đang nhập trong mục này.": "The template will override what you're entering in this section.",
    "Mặc định là 12 tháng nếu bạn không thay đổi.": "The default is 12 months if you don't change it.",
    "Mặt hàng trong đơn": "Items in the order",
    "Mọi thay đổi chưa lưu sẽ bị mất.": "Any unsaved changes will be lost.",
    "Mới ra mắt": "Newly released",
    "Người ghi": "Recorder",
    "Người tạo": "Creator",
    "Nhãn thông số": "Parameter label",
    "Nhập SKU": "Enter SKU",
    "Nhập chú thích bộ ảnh": "Enter photo set caption",
    "Nhập giá bán lẻ": "Enter retail price",
    "Nhập giá bán lẻ thực tế của sản phẩm.": "Enter the actual retail price of the product.",
    "Nhập giá trị": "Enter value",
    "Nhập lý do tạm khóa đại lý...": "Enter the reason for temporarily locking the agent...",
    "Nhập mô tả": "Enter a description",
    "Nhập mô tả ngắn": "Enter a short description",
    "Nhập nhãn": "Enter label",
    "Nhập tiêu đề": "Enter a title",
    "Nhập tên sản phẩm": "Enter the product name",
    "Nút \"Dùng mẫu\" sẽ tạo sẵn một bố cục cơ bản để bạn chỉnh sửa nhanh hơn.": "The \"Use Template\" button will create a basic layout for you to edit faster.",
    "Phương thức": "Method",
    "Rời khỏi trang?": "Leave the page?",
    "Rời đi": "Leave",
    "SKU": "SKU",
    "Sản phẩm sẽ được lưu với giá bán lẻ bằng 0. Hãy xác nhận nếu đây là chủ đích của bạn.": "The product will be saved at a retail price of 0. Please confirm if this is your intention.",
    "Sản phẩm đã được tạo thành công": "The product has been created successfully",
    "Số lượng": "Quantity",
    "Số mặt hàng": "Item number",
    "Số tiền không được vượt quá còn lại": "The amount must not exceed the remaining amount",
    ...
    "Trình soạn thảo mô tả chi tiết": "Detailed description editor",
    "Trạng thái đơn {id}": "Single status {id}",
    "Trạng thái đại lý {id}": "Agent status {id}",
    "Tên": "Name",
    "Tìm sản phẩm": "Find products",
    "Tạo sản phẩm với giá 0 VND?": "Create a product for 0 VND?",
    "Tắt xem trước": "Turn off preview",
    "Tối đa 120 tháng": "Maximum 120 months",
    "Tồn": "Exist",
    "Tổng cộng": "Total",
    "Tổng tiền": "Total amount",
    "URL video không hợp lệ": "Invalid video URL",
    "Video này hiển thị xen kẽ trong mô tả chi tiết. Nếu muốn có khu vực video riêng cho sản phẩm, dùng tab \"Video\".": "This video appears interspersed in the detailed description. If you want a separate video area for your product, use the \"Video\" tab.",
    "Vui lòng kiểm tra lại các trường bắt buộc": "Please review required fields",
    "Vui lòng nhập URL video": "Please enter video URL",
    "Vui lòng nhập giá bán lẻ": "Please enter retail price",
    "Về đơn hàng": "Back to orders",
    "Ví dụ: UPDATE_ORDER...": "For example: UPDATE_ORDER...",
    "Vẫn tạo": "Still creating",
    "Về danh sách": "About the list",
    "Về sản phẩm": "About the product",
    "Về đại lý": "About the agent",
    "Xem lại giá": "Review prices",
    "Xem trước bài viết — hiển thị như trang public.": "Post preview — displayed as a public page.",
    "Xuống": "Down",
    ...
    "Đang tạo...": "Creating...",
    "Điều chỉnh tài chính": "Financial adjustments",
    "Đoạn này dùng cho phần tóm tắt ngắn. Nội dung đầy đủ được xây dựng ở tab \"Mô tả chi tiết\".": "This paragraph is for a short summary. The full content is built in the \"Detailed Description\" tab.",
    "Đánh dấu mới ra mắt": "New bookmark launched",
    "Đánh dấu nổi bật": "Highlight",
    "Đã cập nhật {id}": "Updated {id}",
    "Đã ghi nhận thanh toán cho đơn {id}": "Payment has been recorded for order {id}",
    "Đã hủy xuất bản sản phẩm.": "Product unpublished.",
    "Đã khôi phục sản phẩm về bản nháp.": "Product has been restored to draft.",
    "Đã thanh toán": "Paid",
    "Đã thêm điều chỉnh tài chính": "Added financial adjustments",
    "Đã xuất bản sản phẩm.": "Published product.",
    "Đã xóa vĩnh viễn sản phẩm.": "Product permanently deleted.",
    "Đã xóa {id}": "Deleted {id}",
    "Đã ẩn sản phẩm khỏi danh mục.": "Product has been hidden from the catalog.",
    "Đăng nhập để truy cập hệ thống quản lý phân phối của 4T HITEK": "Log in to access 4T HITEK's distribution management system",
    "Đơn giá": "Unit price",
    "Đơn hàng đã hoàn tất. Xác nhận để tạo điều chỉnh tài chính.": "Order has been completed. Confirm to create financial adjustment.",
    "Đơn này đã hết hạn xử lý nhưng có thanh toán ghi nhận — cần xem xét thủ công trước khi hủy.": "This application has expired but has a recorded payment — manual review is required before cancellation.",
    "Đơn {id} -> {status}": "Order {id} -> {status}",
    "Đơn {id} không tồn tại hoặc đã bị xóa.": "Order {id} does not exist or has been deleted.",
    "Đường dẫn": "Path",
    "Đại lý {id} không tồn tại.": "Agent {id} does not exist.",
    "Đặt lại": "Reset",
    "Địa chỉ": "Address",
    "Ẩn bộ lọc": "Hide filters",
    "Ẩn sản phẩm này khỏi danh mục hiện hành?": "Hide this product from the current catalog?",
    "Ẩn sản phẩm này khỏi danh mục?": "Hide this product from the catalog?",
    "Ở lại": "Stay",
    ...operationalPageTranslations,
