...
const AdditionalContent = ({ selectedSeries, productCount }: AdditionalContentProps) => {
    // Only show when there are few products (less than 8)
    if (productCount >= 8) return null;

    return (
        <motion.div
            className="ml-16 sm:ml-20 mt-12 sm:mt-16 mb-16"
