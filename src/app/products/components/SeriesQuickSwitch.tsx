...
export default function SeriesQuickSwitch({ selectedSeries, onSeriesClick }: SeriesQuickSwitchProps) {
        ...
        <div className="relative">
            ...
            >
                <div className="flex items-center space-x-2 flex-1">
                    <div className="w-3 h-3 rounded-full" style={{ backgroundColor: currentSeries.color }} />
                    <span className="text-white text-sm font-medium">{currentSeries.label}</span>
                </div>
