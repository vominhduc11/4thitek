    ...
    return (
        <section id="product-details" className="bg-[#0a0f1a] relative z-50 -mt-20 min-h-screen">
            <div className="container mx-auto max-w-8xl relative -top-48 py-20">
                <h2 className="text-3xl font-bold mb-8 text-white">CHÍNH SÁCH BẢO HÀNH</h2>

                {/* Warranty Overview */}
                <div className="bg-gradient-to-br from-blue-600/20 to-purple-600/20 rounded-2xl p-8 border border-gray-700/50 mb-12">
                    <div className="text-center mb-8">
                        <div className="w-24 h-24 bg-blue-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                            <span className="text-4xl">🛡️</span>
                        </div>
                        <h3 className="text-2xl font-bold text-white mb-2">BẢO HÀNH 24 THÁNG</h3>
                ...
                <div className="bg-gray-800/70 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 mb-12">
                    <h3 className="text-2xl font-bold text-white mb-8 text-center">QUY TRÌNH BẢO HÀNH</h3>
                ...
                {/* Contact Information */}
                <div className="bg-gray-800/70 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50">
                    <h3 className="text-2xl font-bold text-white mb-6 text-center">THÔNG TIN BẢO HÀNH</h3>
