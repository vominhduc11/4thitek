    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-[#2c2327] via-[#21233b] to-[#151622] px-2 xs:px-4 sm:px-8 md:px-12 lg:px-20">
            ...
            >
                ...
                <motion.h1
                    className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-red-300 mb-2 text-center"
                    variants={titleVariants}
                >
                    Đã có lỗi xảy ra
                </motion.h1>
                <motion.p
                    className="text-gray-400 text-sm xs:text-base sm:text-lg md:text-xl text-center mb-5"
