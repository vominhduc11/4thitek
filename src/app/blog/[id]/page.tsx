    ...
    return (
        <div className="min-h-screen bg-[#0c131d] main-content">
            ...
            <section className="relative w-full h-[400px] overflow-hidden">
                ...
                <motion.div
                    className="absolute bottom-16 sm:bottom-20 lg:bottom-24 left-4 sm:left-6 lg:left-8 z-20"
            ...
            <section className="bg-[#0c131d] pb-8">
                ...
                <div className="w-full">
                    ...
                    >
                        <Image
                            src="/ace45cbf5c089422f94ce1f28689d06b472617bc.png"
                            alt={post.title}
                            fill
                                            ...
                                            <div className="w-full max-w-[350px] bg-[#1a2332] rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-200 ease-in-out overflow-hidden group border border-gray-800/30">
                                                ...
                                                <div className="p-4 relative">
                                                    ...
                                                    <div className="flex items-center gap-2 mb-2">
                                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="text-white opacity-60">
                                                    ...
                                                    <p className="text-base text-gray-300 leading-6 line-clamp-3 mb-4">
                                                        Tìm hiểu về những tính năng vượt trội và cách sử dụng hiệu quả trong các chuyến đi của bạn.
                                                    </p>
