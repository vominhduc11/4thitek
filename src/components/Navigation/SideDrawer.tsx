                                        ...
                                        {['SX Series', 'S Series', 'G Series', 'G+ Series'].map((item, index) => (
                                            ...
                                            >
                                                <motion.button
                                                    ...
                                                    disabled={isNavigating}
                                                    className={`block w-full text-left text-xs sm:text-sm py-0.5 sm:py-1 transition-all duration-200 ${
                                                        isNavigating
                                                            ? 'text-gray-500 cursor-not-allowed'
                                                ...
                                                >
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        {isNavigating && (
                                                            <motion.div
                                                                className="w-3 h-3 border border-[#4FC8FF] border-t-transparent rounded-full"
                                                                animate={{ rotate: 360 }}
                                                                transition={{
                                                                    duration: 1,
                                                                    repeat: Infinity,
